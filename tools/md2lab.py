...
"""Render a lab markdown file into a standalone, offline Majal-branded HTML page.
    ...
    python3 tools/md2lab.py day1/lab1.md day1/lab1.html "Day 1 · Lab 1" "Robotics 2026"

Argument 3 is the breadcrumb shown in the top bar; argument 4 (optional, or the
MAJAL_COURSE env var) is the course name printed in the footer.
...
def main():
    ...
    course = sys.argv[4] if len(sys.argv) > 4 else os.environ.get("MAJAL_COURSE", "Majal 2026")
